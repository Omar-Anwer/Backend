...
public class CredentialsController {
    ...
    public String deleteCredential( 
        ...
        // Check if credentials exists and is owned by the user
        // User user = userService.getUser(authentication.getName());
        // Optional<Credentials> credentialOptional = Optional.ofNullable(credentialService.findByIdAndUserId(credentialId, user.getId()));

        // if (credentialOptional.isEmpty()) {
        //     log.error("Credentials with ID '{}' not found for user '{}' or access denied", credentialId, user.getId());
        // }
