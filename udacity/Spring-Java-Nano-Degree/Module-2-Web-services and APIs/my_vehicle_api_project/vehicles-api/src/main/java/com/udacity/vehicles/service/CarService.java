...
public class CarService {
    ...
    private final PriceClient priceEndpoint;
    private final MapsClient mapsEndpoint;


    public CarService(CarRepository repository, PriceClient price, MapsClient maps) {
        this.repository = repository;
        this.priceEndpoint = price;
        this.mapsEndpoint = maps;
    }
    ...
    public Car findById(Long id) {
        ...
        car.setPrice(priceEndpoint.getPrice(id));
        /**
